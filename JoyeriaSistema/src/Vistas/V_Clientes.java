...
public class V_Clientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/joyeria/imagenes/sucursales.png"))); // NOI18N
        jButton1.setText("Sucursales");
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 0, 160, 80));

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/joyeria/imagenes/ventas.png"))); // NOI18N
        jButton2.setText("Ventas");
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 0, 160, 80));

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/joyeria/imagenes/usuarios.png"))); // NOI18N
        jButton3.setText("Usuarios");
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 0, 160, 80));

        btnReportes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/joyeria/imagenes/reportes.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        ControladorC c= new ControladorC(v);
        v.setVisible(true);
