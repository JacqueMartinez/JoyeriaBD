 ...
 */
public class V_AgregarProducto extends javax.swing.JFrame {
    ConsultasProducto model;
    Controlador cont;
    /**
     * Creates new form V_AgregarProducto
     */
    public V_AgregarProducto() throws IOException, ClassNotFoundException, URISyntaxException {
        initComponents();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        try {
            ...
            Logger.getLogger(V_AgregarProducto.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new V_AgregarProducto().setVisible(true);
